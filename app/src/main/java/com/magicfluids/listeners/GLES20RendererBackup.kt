...
open class GLES20RendererBackup(var activity: Context?, private val nativeInterface: NativeInterface?, private val orientationSensor: OrientationSensor?, private val settings: Settings?) : GLSurfaceView.Renderer {
